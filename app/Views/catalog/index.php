            ...
            <div class="row categories">
                ...
                <div class="col-3 order-2 ">
                    ...
                    <ul class="list-unstyled small text-muted pl-4 font-weight-normal">
                        <li class="mb-2"><a class="reset-anchor category-item" href="#" data-category="bicycle">Women's </a></li>
                        <li class="mb-2"><a class="reset-anchor category-item" href="#" data-category="bicycle">Unisex</a></li>
                        <li class="mb-2"><a class="reset-anchor category-item" href="#" data-category="bicycle">For Kids</a></li>
                        <li class="mb-2"><a class="reset-anchor category-item" href="#" data-category="bicycle">Teenager</a></li>
                        <li class="mb-2"><a class="reset-anchor category-item" href="#" data-category="bicycle">City</a></li>
                        <li class="mb-2"><a class="reset-anchor category-item" href="#" data-category="bicycle">Electrical</a></li>
                    </ul>
